...
const NavigataItem = (props: NavigataItemProps) => {
	const { leftIcon, title, detail, value, rightIcon, onClick = () => {}, to } = props
	...
	return (
		...
		>
			...
			<section className="flex items-center">
				{value}
				{rightIcon ? rightIcon : <ArrowForwardIosIcon sx={{ fontSize: '0.8rem', ml: '0.8rem' }} />}
			</section>
		</div>
	)
}

export default NavigataItem
